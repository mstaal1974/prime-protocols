...
export const metadata: Metadata = {
  title: 'Testosterone & Hormonal Health — Telehealth Assessment Australia',
  description:
    "Comprehensive hormone assessment and medically supervised testosterone optimisation. Total and free T, LH, FSH, oestradiol — read in clinical context.",
  keywords: [
  ...
  alternates: { canonical: '/treatments/testosterone' },
}
  ...
  return (
    <Layout>
      <TreatmentHero
        ...
        subtitle="What &lsquo;low testosterone&rsquo; actually feels like, what a proper hormone panel measures, and how testosterone optimisation works in Australia under medical supervision."
      />

      <article className="bg-white py-16 md:py-24">
        <div className="container-site">
          <ProseSection>
            <h2>What low testosterone actually feels like</h2>
            <p>
              Low testosterone rarely arrives as a single dramatic symptom. More often it is a slow
            ...
            <h2>Total vs free testosterone — why the number matters</h2>
            <p>
              A standard GP test usually reports only <strong>total testosterone</strong>. That
              number is genuinely useful, but it&apos;s incomplete. Most of the testosterone in your
              blood is bound to a protein called sex-hormone binding globulin (SHBG) and is not
              biologically available. The fraction that is unbound — <strong>free testosterone
              </strong> — is what actually reaches tissues.
            </p>
            <p>
              Men with &ldquo;normal&rdquo; total testosterone can have low free testosterone if
            ...
            <p>
              A proper men&apos;s hormone assessment looks beyond testosterone itself. It typically
              includes:
            </p>
            <ul>
              <li>Total and free testosterone, with SHBG calculated</li>
            ...
            <p>
              The panel is read together, not as isolated numbers. A high LH with low testosterone
              tells a different story than a low LH with low testosterone. The clinical picture is
              what matters.
            </p>

            <h2>TRT in Australia — what it involves</h2>
            <p>
              Testosterone replacement therapy (TRT) is a regulated medical treatment in Australia.
              It is appropriate for men with clinically confirmed low testosterone and is prescribed
            ...
            <p>
              ...
              hormonal function without exogenous testosterone. We assess for both.
            </p>
