...
A typical GP visit for fatigue and low mood might involve a basic panel: a total testosterone level, maybe thyroid, maybe iron. The result comes back "in range" and the conversation moves on.

The problem is that "in range" is a population-level statistic that doesn't account for two things that matter clinically.

First, total testosterone is not the most clinically useful single number. Most of the testosterone in your blood is bound to a protein called sex-hormone binding globulin (SHBG) and is not biologically available. The biologically active portion — free testosterone — is what actually reaches tissues. Men can have a "normal" total testosterone and a clinically low free testosterone because their SHBG is elevated. The reverse is also true.

Second, hormone panels make sense in relation to each other, not in isolation. A low testosterone with a high LH suggests primary hypogonadism — the testes are being told to produce testosterone and are not responding. A low testosterone with a low LH suggests a secondary issue — the signal from the brain isn't being sent at the level required. These are clinically different pictures and they have different treatment paths.
...
- Total and free testosterone, with SHBG calculated
- LH and FSH
- Oestradiol (E2)
- Prolactin
...
Sometimes the answer is: your testosterone is genuinely low and treatment is clinically indicated. Sometimes the answer is: your testosterone is borderline and there are upstream drivers — sleep, insulin resistance, alcohol, body composition — that, addressed properly, will restore hormonal function without exogenous treatment.
