...
- Reduced SHBG, which changes how testosterone behaves in the body
- Increased aromatase activity, which converts testosterone to oestradiol
...
Later, as the picture progresses: cognitive cloudiness after meals, increased hunger between meals, sleep that doesn't restore as it should, and the hormonal patterns mentioned above — lower free testosterone, higher oestradiol, lower SHBG.
